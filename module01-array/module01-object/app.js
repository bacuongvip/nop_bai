...
// };
// //creat
// let creat = prompt("Nhap keyword moi:");
// let content = prompt("Nhap noi dung keyword:");
// dictionary[creat] = content;

// //read
// let n = prompt("Nhap keyword:");
//   if (dictionary[n]) {
//     alert(`${dictionary[n]}`);
//   } else {
//     alert(`${n} khong xac dinh`);
//   }
...
// //read
// let n = prompt("Nhap vi tri xe");
// if(cars[n]){
//     console.log(cars[n]);
// }

// let cate = prompt("Nhap category:");
// for(let key in cars){
//     if(cate == cars[key].category){
//         console.log(cars[key]);
//     }
// }

// //Create
// cars[1].Provider = ["ZeroAuto", "VhStore"];
// cars[2].Provider = ["HAauto", "VhStore"];
// cars[3].Provider = "HAauto";
// cars[4].Provider = "HAauto";
// console.log(cars);

// //read
// let pro = prompt("Nhap providers :");
// for(let key in cars){
//     if(pro == cars[key].Provider || cars[key].Provider.includes(pro) == true){
//         console.log(cars[key]);
//     }
// }
...
//     },
//     {
//         id: "Basic of Javascript",
//         Complete: false
//     },
//     {
//         id: "Node Package Manager(npm)",
//         Complete: false
//     },
//     {
//         id: "Git",
...
//     }
// ];
// console.log("Hi, this is your task");
// let check = "";
// do{
//     let n = prompt("Nhap (new, delete, update, complete)");
//     switch(n) {
//         case "new":
//             let create = prompt("Nhap new task");
//             let add = {
//                 id: create,
//                 Complete: false
//             }
...
//                     console.log(`${(i+1)}. ${task[i]["id"]}`);
//                     console.log(`Complete. ${task[i]["Complete"]}`);
//             }
//             break;

//         case "update":
//             let update = prompt("Nhap title update");
//             let pos = prompt("Nhap vi tri ");
//             task[pos-1]["id"] = update;
//             for(let i = 0; i < task.length; i++){
//                 console.log(`${(i+1)}. ${task[i]["id"]}`);
//                 console.log(`Complete. ${task[i]["Complete"]}`);
//             }
...
//         case "complete":
//             let pos2 = prompt("Nhap vi tri complete");
//             task[pos2-1].Complete = true;
//             for(let i = 0; i < task.length; i++){
//                 console.log(`${(i+1)}. ${task[i]["id"]}`);
//                 console.log(`Complete. ${task[i]["Complete"]}`);
//             }
...
//         case "delete":
//             let pos3 = prompt("Nhap vi tri xoa");
//             task.splice(pos3-1, 1);
//             for(let i = 0; i < task.length; i++){
//                 console.log(`${(i+1)}. ${task[i]["id"]}`);
//                 console.log(`Complete. ${task[i]["Complete"]}`);
//             }
...
//             break;
//     }
//     check = prompt("Ban muon tiep tuc khong");
// } while(check != "q");
